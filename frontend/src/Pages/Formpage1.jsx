...
const Formpage1 = () => {
  ...
  return (
    <div className='w-full h-fit flex flex-col justify-center items-center'>
      ...
      <button className="w-[189px] h-[67px] bg-violet-600 rounded-[10px] border-white text-white text-3xl font-bold font-['Poppins'] mt-[7vh] mb-[10vh] max-sm:w-[280px] max-sm:h-[40px] max-sm:mt-[-7rem] max-sm:text-[22px] max-sm:hidden max-sm:mb-[2rem]" onClick={handelSubmit}>Next</button>
    </div>
  );
}
