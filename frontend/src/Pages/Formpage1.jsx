  ...
  return (
    <div className='w-full h-fit flex flex-col justify-center items-center'>
      ...
      <div className="w-[852px] h-[584.17px] rounded-2xl border border-white backdrop-blur-[22px] mt-[5vh] justify-center flex flex-col items-center max-sm:border-none max-sm:w-screen max-sm:backdrop-blur-0 max-sm:mt-[-5rem]">
        ...
        <button className="w-[189px] h-[67px] bg-violet-600 rounded-[10px] border-white text-white text-3xl font-bold font-['Poppins'] mt-[8vh] mb-[10vh] max-sm:w-[280px] max-sm:h-[40px] max-sm:mt-[3rem] max-sm:text-[22px] sm:hidden max-sm:mb-[10rem]" onClick={handelSubmit}>Next</button>
      </div>
