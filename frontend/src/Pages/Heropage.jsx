...
const Heropage = () => {
  ...
  return (
    <div className='w-full h-fit flex flex-col justify-center items-center'>
      <Navbar/>
      <div className="relative text-white text-[60px] font-bold font-['Poppins'] max-sm:text-[26px] flex mt-[8vh]">Affiliate Program</div>
      ...
      <div className='flex mt-[5rem] max-sm:mt-[2.2rem]'>
        ...
        <div className="w-[1080px] h-[168px] bg-zinc-900 rounded-[15px] border border-white max-sm:w-[250px] max-sm:h-[70px] max-sm:rouded-[10px] flex flex-col" >
          ...
          <div className="w-[943px] text-white text-[20px] font-normal font-['Poppins'] leading-[37px] ml-[6rem] max-sm:ml-[1.5rem] max-sm:mt-[0.1vh] max-sm:w-[218px] max-sm:text-[8px] max-sm:leading-3 max-sm:mt-[-0.1vh]">Fill out our quick form and join our dedicated network of affiliates. It's free and only takes a few minutes!</div>
        </div>
      </div>
      ...
      <button className="w-[220px] h-[65px] bg-violet-600 rounded-[10px] border-white text-white text-[25px] font-bold font-['Poppins'] mt-[7rem] mb-[10rem] max-sm:w-[100px] max-sm:h-[26.89px] max-sm:text-[10px] max-sm:mt-[2rem] max-sm:mb-[4rem]" onClick={() => navigator('/page1')}>Fill the form</button>
